              ...
              <ul class="of" id="bna">
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      ...
                      <span lass="fl jgAttr c-ccc f-fA">
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of"> <span class="fr jgTag bg-green">                        <i
                      class="c-fff fsize12 f-fA">免费</i>
                    </span>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="零基础入门学习Python课程学习" class="course-title fsize18 c-333">
                        零基础入门学习Python课程学习</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
              ...
              <ul class="of">
                ...
                <li>
                  <section class="i-teach-wrap">
                    ...
                    <div class="mt10 hLh30 txtOf tac"><a href="/teacher/1" title="周润发" class="fsize18 c-666">周润发</a>
                    </div>
                    <div class="hLh30 txtOf tac">
